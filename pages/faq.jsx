...
const groups = [
  {
    ...
    faqs: [
      {
        id: 'not-vpn',
        q: 'Magic Door 是 VPN 嗎？',
        a: '不是。Magic Door 並非 VPN。VPN 會將您所有的網絡流量改道，而 Magic Door 只針對特定 AI 工具的連線進行優化，其他所有網絡活動不受影響。',
      },
      {
        id: 'session-expired',
        q: '連線時間到了會怎樣？',
      ...
      {
        id: 'quota-reset',
        q: '每日配額是怎樣計算的？可以連線多少次？',
        a: (
          <>
            Magic Door 的計劃限制有兩個維度：<strong>每次連線的時限</strong>（例如每次最多 60 分鐘）及<strong>每日總使用時數上限</strong>（例如每日最多 3 小時）。系統<strong>不限制每日連線次數</strong>——只要您的每日時數未用完，您可以隨時中斷並重新連線。
            <br /><br />
  ...
  },
  {
    ...
    faqs: [
      ...
      {
        id: 'concurrent-devices',
        q: '同一帳號可以在多個裝置同時連線嗎？',
        a: '每個帳號同一時間只能在一個裝置上使用（Basic 及 Plus 計劃）。如需多個裝置同時連線，MAX 計劃支援最多 5 個裝置同時連線。如在其他裝置上登入，現有連線將自動中斷。',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    faqs: [
      {
        id: 'data-privacy',
        q: '使用 Magic Door 安全嗎？你們會看到我的帳號密碼或對話內容嗎？',
        a: (
          <>
